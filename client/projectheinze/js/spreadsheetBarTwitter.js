...
function SpreadsheetBarTwitter(svg, url) {
...
// it from CircleVis.
SpreadsheetBarTwitter.prototype = Object.create(SpreadsheetVis.prototype); // See note below

// Set the "constructor" property to refer to CircleVis
SpreadsheetBarTwitter.prototype.constructor = SpreadsheetBarTwitter;

    // Replace the "sayHello" method
SpreadsheetBarTwitter.prototype.drawGraph = function(){
    var Vis = this;
   //TODO: custom keys!
    var data = this.data.twitter.elements;
